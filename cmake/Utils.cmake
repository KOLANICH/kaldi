...
macro(add_kaldi_executable)
    if(${KALDI_BUILD_EXE})
        ...
        #harden("{kaldi_exe_NAME}")
        # list(APPEND KALDI_EXECUTABLES ${kaldi_exe_NAME})
        cpack_add_component("${kaldi_exe_NAME}" GROUP "tools" DISPLAY_NAME "${kaldi_exe_NAME}")
        install(TARGETS ${kaldi_exe_NAME} RUNTIME DESTINATION ${CMAKE_INSTALL_BINDIR} COMPONENT "${kaldi_exe_NAME}")
...
macro(add_kaldi_test_executable)
    if(${KALDI_BUILD_TEST})
        ...
        cpack_add_component("${kaldi_test_exe_NAME}" GROUP "tests" DISPLAY_NAME "${kaldi_test_exe_NAME}")
        install(TARGETS ${kaldi_test_exe_NAME} RUNTIME DESTINATION testbin COMPONENT "${kaldi_test_exe_NAME}")
